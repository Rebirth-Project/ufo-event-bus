...
public class ListenerToTenEventsWith10000Latency {

    private static final Logger logger = LoggerFactory.getLogger(ListenerToTenEventsWith10000Latency.class);

    private final CountDownLatch countDownLatch;
    private int listenerNumber;

    public ListenerToTenEventsWith10000Latency(CountDownLatch countDownLatch) {
