...
public class ListenerToTenEventsWith100Latency {

    private static final Logger logger = LoggerFactory.getLogger(ListenerToTenEventsWith100Latency.class);

    private final CountDownLatch countDownLatch;
    private int listenerNumber;

    public ListenerToTenEventsWith100Latency(CountDownLatch countDownLatch) {
