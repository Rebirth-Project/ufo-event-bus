...
public class ListenerToTenEventsWith500Latency {

    private static final Logger logger = LoggerFactory.getLogger(ListenerToTenEventsWith500Latency.class);

    private final CountDownLatch countDownLatch;
    private int listenerNumber;

    public ListenerToTenEventsWith500Latency(CountDownLatch countDownLatch) {
