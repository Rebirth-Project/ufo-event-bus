...
public class ListenerToTenEventsWithNoLatency {

    private static final Logger logger = LoggerFactory.getLogger(ListenerToTenEventsWithNoLatency.class);

    private final CountDownLatch countDownLatch;
    private int listenerNumber;

    public ListenerToTenEventsWithNoLatency(CountDownLatch countDownLatch) {
