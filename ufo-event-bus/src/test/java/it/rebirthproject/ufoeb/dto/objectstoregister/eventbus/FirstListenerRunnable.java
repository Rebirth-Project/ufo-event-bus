...
public class FirstListenerRunnable extends AbstractRunnable {

    private static final Logger logger = LoggerFactory.getLogger(FirstListenerRunnable.class);

    public FirstListenerRunnable(long sleepTime) {
        super(sleepTime);
    }   
