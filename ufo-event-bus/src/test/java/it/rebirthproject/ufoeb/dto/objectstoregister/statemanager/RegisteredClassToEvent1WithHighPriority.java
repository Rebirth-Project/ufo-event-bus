...
public class RegisteredClassToEvent1WithHighPriority {

    private static final Logger logger = LoggerFactory.getLogger(RegisteredClassToEvent1WithHighPriority.class);
