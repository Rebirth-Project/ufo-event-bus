...
public class RegisteredClassToEvent1WithMediumPriority {

    private static final Logger logger = LoggerFactory.getLogger(RegisteredClassToEvent1WithMediumPriority.class);
