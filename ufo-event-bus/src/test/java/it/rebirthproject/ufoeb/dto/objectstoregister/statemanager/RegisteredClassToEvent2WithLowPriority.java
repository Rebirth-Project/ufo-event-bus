...
public class RegisteredClassToEvent2WithLowPriority {

    private static final Logger logger = LoggerFactory.getLogger(RegisteredClassToEvent2WithLowPriority.class);
