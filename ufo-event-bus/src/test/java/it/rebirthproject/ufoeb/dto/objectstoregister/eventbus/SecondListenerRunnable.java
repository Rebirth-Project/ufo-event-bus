...
public class SecondListenerRunnable extends AbstractRunnable {

    private static final Logger logger = LoggerFactory.getLogger(SecondListenerRunnable.class);

    public SecondListenerRunnable(long sleepTime) {
        super(sleepTime);
    }
