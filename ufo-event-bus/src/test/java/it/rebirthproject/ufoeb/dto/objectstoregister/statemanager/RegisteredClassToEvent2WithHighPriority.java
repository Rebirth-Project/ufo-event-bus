...
public class RegisteredClassToEvent2WithHighPriority {

    private static final Logger logger = LoggerFactory.getLogger(RegisteredClassToEvent2WithHighPriority.class);

    @Listen(priority = EventPriority.HIGH_VALUE)
