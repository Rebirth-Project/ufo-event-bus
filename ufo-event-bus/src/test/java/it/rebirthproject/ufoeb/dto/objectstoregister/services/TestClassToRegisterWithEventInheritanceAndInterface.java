...
public class TestClassToRegisterWithEventInheritanceAndInterface {

    @Listen
    public void method1(TestEventParent event) {

    }

    @Listen
    public void method1(TestEventWithParentClass event) {
    }

    @Listen
    public void method2(EventInterfaceExtendingInterfaces event) {
    }
}
