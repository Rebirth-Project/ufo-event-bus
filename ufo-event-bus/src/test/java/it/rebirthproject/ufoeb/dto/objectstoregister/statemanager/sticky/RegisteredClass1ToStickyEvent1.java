 ...
 */
package it.rebirthproject.ufoeb.dto.objectstoregister.statemanager.sticky;
...
public class RegisteredClass1ToStickyEvent1 {

    private static final Logger logger = LoggerFactory.getLogger(RegisteredClass1ToStickyEvent1.class);
