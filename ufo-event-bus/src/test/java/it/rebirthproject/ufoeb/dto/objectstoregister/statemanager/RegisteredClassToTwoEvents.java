...
public class RegisteredClassToTwoEvents {

    private static final Logger logger = LoggerFactory.getLogger(RegisteredClassToTwoEvents.class);
    ...
    @Listen
    public void onEvent2(TestEvent2 testEvent2) {
