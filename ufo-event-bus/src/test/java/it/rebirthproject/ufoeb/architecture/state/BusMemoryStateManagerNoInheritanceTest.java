...
public class BusMemoryStateManagerNoInheritanceTest extends BaseTest {
    ...
    public void beforeEach() {
        ...
        memoryState = new MemoryState(!SAFE_REGISTRATIONS_NEEDED, FactoryInheritancePolicy.createInheritancePolicy(InheritancePolicyType.NO_EVENT_INHERITANCE,classProcessableService), VERBOSE_LOGGING);
