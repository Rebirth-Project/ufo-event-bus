...
public class ListenerForBuilderDefaultsTest {

    private final CountDownLatch eventReceivedLatch = new CountDownLatch(1);
    ...
    public boolean awaitEvent(long timeout, TimeUnit timeUnit) throws InterruptedException {
        return eventReceivedLatch.await(timeout, timeUnit);
    }
}
