...
public class BusMemoryStateManagerInheritanceOverClassesTest extends BaseTest {
    ...
    public void beforeEach() {
        ...
        memoryState = new MemoryState(!SAFE_REGISTRATIONS_NEEDED, FactoryInheritancePolicy.createInheritancePolicy(InheritancePolicyType.CLASS_EVENT_INHERITANCE,classProcessableService), VERBOSE_LOGGING);
    ...
    @Test
    public void avoid_to_send_for_event_interface() throws Exception {
    ...
    @Test
    public void send_event_only_to_classes_and_superclasses() throws Exception {
    ...
    @Test
    public void test_cascade_on_superclasses_when_listener_doesnt_listen_to_the_class() throws Exception {
