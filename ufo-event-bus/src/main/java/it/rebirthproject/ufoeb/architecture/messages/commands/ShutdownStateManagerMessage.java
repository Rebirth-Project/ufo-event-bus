...
/**
 * An internal message sent from the event bus infrastructure to {@link BusMemoryStateManager} when the shutdown method of the {@link EventBus} is invoked.
 * After receiving this message, the {@link BusMemoryStateManager} will shut down.
 *
 * @see EventBus
...
public class ShutdownStateManagerMessage extends AbstractCommandMessage {
    ...
    /**
     * The constructor to build a {@link ShutdownStateManagerMessage}
     */
    public ShutdownStateManagerMessage() {
    }
    ...
    public MessageType getMessageType() {
        return MessageType.SHUTDOWN_STATE_MANAGER;
    }
}
